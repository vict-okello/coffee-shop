  ...
  const slides = [
    {
      ...
      title: "Our Story",
      text:
        "Eliza Is An Online Coffee Store That Offers The Widest Selection Of Specialty Coffees And Teas From Around The World...",
    },
    {
      image: ourstory,
      title: "Freshly Roasted",
      text:
        "We roast our beans in small batches to ensure bold flavor, rich aroma, and perfect freshness in every cup.",
    },
    {
      image: ourstory,
      title: "From Farm to Cup",
      text:
        "We partner with trusted farmers worldwide to bring you sustainable, high-quality coffee every day.",
    },
  ];
